...
public class RemoveProductFromCategoryToolTest {

    private final RemoveProductFromCategoryTool tool = new RemoveProductFromCategoryTool();

    @Test
    public void exposesStableToolName() {
        assertEquals("remove_product_from_category", tool.name());
    }
